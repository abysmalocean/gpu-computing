...
int WM = 1024; // Matrix M width
int HM = 1024; // Matrix M height
int WN = 1024; // Matrix N width
int HN = WM;  // Matrix N height
int WP = WN;  // Matrix P width 
int HP = HM;  // Matrix P height
